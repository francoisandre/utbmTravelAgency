...
<div class="container mt-3">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                foreach ($packages as $index => $package) {
                    ...
                    echo "<td>";
                    echo "<a href='".getBaseUrl()."controller/package/c_editPackage.php?id=".$package['package_id']."' style='cursor:pointer'>
                            <i title='Edit' class='material-icons' style='color: green;'>edit</i></a>&nbsp;";
                    echo "<a href='".getBaseUrl()."controller/package/c_deletePackage.php?id=".$package['package_id']."' onclick='return confirmDelete();' style='cursor:pointer'>
    ...
    <div class="text-end">
        <form style="display: inline-block;" method="post" action="<?php echo getBaseUrl()?>controller/package/c_newPackage.php">
